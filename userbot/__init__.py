...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/Alonezkly/ALONEZKLY-UBOT")
UPSTREAM_REPO_BRANCH = os.environ.get(
    "UPSTREAM_REPO_BRANCH", "Alonezkly-UserBot")
...
# Bot Name
TERM_ALIAS = os.environ.get("TERM_ALIAS", "Alone-UserBot")
...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO") or "https://telegra.ph/file/d72fcf3d9133a473e4138.jpg"

# Default .helpme Logo
INLINE_PIC = os.environ.get(
    "INLINE_PIC") or "https://telegra.ph/file/d72fcf3d9133a473e4138.jpg"
...
async def check_alive():
    await bot.send_message(BOTLOG_CHATID, "```𝘊𝘰𝘯𝘨𝘳𝘢𝘵𝘴𝘴... ⚡Aʟᴏɴᴇ - Pʀᴏᴊᴇᴄᴛ⚡ Has Been Active!!```")
    return
...
with bot:
    try:
        ...
        async def opeen(event):
            try:
                ...
                if tgbotusername is not None:
                    results = await event.client.inline_query(tgbotusername, "@Alonezkly")
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith(
                ...
                result = builder.photo(
                    file=geezlogo,
                    link_preview=False,
                    text=f"⚡Aʟᴏɴᴇ - Pʀᴏᴊᴇᴄᴛ⚡\n\n⚡**Owner : {DEFAULTUSER}**\n\n⚡ **Bot Ver :** `5.0`\n⚡ **𝗠odules :** `{len(plugins)}`\n\n⚡ **Dev : Alonezkly **".format(
                        len(dugmeler),
                    ),
                    buttons=buttons,
                )
                ...
                result = builder.article(
                    " ⚡Aʟᴏɴᴇ - Pʀᴏᴊᴇᴄᴛ⚡ ",
                    text="""**⚡Aʟᴏɴᴇ - Pʀᴏᴊᴇᴄᴛ⚡\n\n Anda Bisa Membuat ⚡Aʟᴏɴᴇ - Pʀᴏᴊᴇᴄᴛ⚡Anda Sendiri Dengan Cara:** __TEKEN DIBAWAH INI!__ 👇""",
                    buttons=[
                        [
                            custom.Button.url(
                                "⚡Aʟᴏɴᴇ - Pʀᴏᴊᴇᴄᴛ⚡",
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:  # @Alonezkly
                # https://t.me/TelethonChat/115200
                await event.edit(
                    file=geezlogo,
                    link_preview=True,
